...
![](https://user-images.githubusercontent.com/6702424/74597663-160a9c80-5063-11ea-9542-4437de0b7c66.png)
 ...
 💧Type safe replacement for Node's EventEmitter embracing functional programming \(change from gitbook\)💧  
...
* [Motivation](docs.md#motivation)
* [Try it](docs.md#try-it)
* [Side by side comparison with `EventEmitter`](docs.md#side-by-side-comparison-with-eventemitter)
  * [Reference example](docs.md#reference-example)
  * [Equivalent, the recommended approach:](docs.md#equivalent-the-recommended-approach)
  * [Equivalent, traditional approach:](docs.md#equivalent-traditional-approach)
* [Side by side comparison with `RxJS`](docs.md#side-by-side-comparison-with-rxjs)
  * [Transcription of the _"get started"_ examples from the `RxJS` documentation.](docs.md#transcription-of-the-get-started-examples-from-the-rxjs-documentation)
    * [First example](docs.md#first-example)
    * [Values](docs.md#values)
  * [Transcription of examples that where not specifically designed to make `RxJS` looks good.](docs.md#transcription-of-examples-that-where-not-specifically-designed-to-make-rxjs-looks-good)
    * [Waiting for the next event of a certain type](docs.md#waiting-for-the-next-event-of-a-certain-type)
  * [Example involving states encapsulation](docs.md#example-involving-states-encapsulation)
* [Dependency requirement](docs.md#dependency-requirement)
* [Table of content](docs.md#table-of-content)
* [Api Documentation](docs.md#api-documentation)
  * [Operator](docs.md#operator)
    * [Operator - Filter](docs.md#operator---filter)
    * [Operator - Type guard](docs.md#operator---type-guard)
    * [Operator - fλ](docs.md#operator---fλ)
      * [fλ Returns](docs.md#fλ-returns)
      * [Stateless fλ](docs.md#stateless-fλ)
      * [Stateful fλ](docs.md#stateful-fλ)
    * [`compose(op1, op2, ...)`](docs.md#composeop1-op2-)
  * [`Evt<T>`](docs.md#evtt)
    * [`evt.[$]attach*(...)` methods](docs.md#evtattach-methods)
      * [Arguments](docs.md#arguments)
        * [Operator](docs.md#operator-1)
        * [Timeout](docs.md#timeout)
        * [BoundTo \( context \)](docs.md#boundto--context-)
        * [Callback](docs.md#callback)
      * [Returned value](docs.md#returned-value)
      * [The `$` prefix](docs.md#the--prefix)
      * [`evt.[$]attach(...)`](docs.md#evtattach)
      * [`evt.[$]attachOnce*(...)`](docs.md#evtattachonce)
      * [`evt.[$]attach[Once]Prepend(...)`](docs.md#evtattachonceprepend)
      * [`evt.[$]attach[Once]Extract(...)`](docs.md#evtattachonceextract)
    * [`evt.post*(data)` methods](docs.md#evtpostdata-methods)
      * [`evt.post(data)`](docs.md#evtpostdata)
      * [`evtPostCount: number`](docs.md#evtpostcount-number)
      * [`evt.postAsyncOnceMatched(data)`](docs.md#evtpostasynconcematcheddata)
      * [`evt.postSyncOnceMatched(data)`](docs.md#evtpostsynconcematcheddata)
    * [The `Handler<T,U>` type](docs.md#the-handlertu-type)
    * [`evt.getHandlers()`](docs.md#evtgethandlers)
    * [`evt.evt[Attach|Detach]: Evt<Handler>` properties](docs.md#evtevtattachdetach-evthandler-properties)
    * [`evt.isHandled(data)`](docs.md#evtishandleddata)
    * [`evt.waitFor(...)`](docs.md#evtwaitfor)
    * [`evt.pipe(...)`](docs.md#evtpipe)
    * [`Evt.merge([evt1, evt2, ...])`](docs.md#evtmergeevt1-evt2-)
    * [Detaching handlers.](docs.md#detaching-handlers)
      * [`evt.detach([boundTo])`](docs.md#evtdetachboundto)
      * [`handler.detach()`](docs.md#handlerdetach)
      * [`ctx.detach([evt])`](docs.md#ctxdetachevt)
  * [`Ctx`](docs.md#ctx)
    * [`ctx.getHandlers()`](docs.md#ctxgethandlers)
    * [`ctx.evtDetach: Evt<Handler[]>`](docs.md#ctxevtdetach-evthandler)
    * [\`\`ctx.detach\(\[evt\]\)](docs.md#ctxdetachevt-1)
  * [`VoidEvt`](docs.md#voidevt)
  * [`Observable<T>`](docs.md#observablet)
* [Difference between `evt.waitFor(...)` and `evt.attachOnce(...)`](docs.md#difference-between-evtwaitfor-and-evtattachonce)
* [Credits](docs.md#credits)
  * [Operators](docs.md#operators)
    * [Operator - Filter](docs.md#operator---filter-1)
    * [Operator - Type guard](docs.md#operator---type-guard-1)
    * [Operator - fλ](docs.md#operator---fλ-1)
      * [fλ returns](docs.md#fλ-returns-1)
      * [Operator - Stateless fλ](docs.md#operator---stateless-fλ)
      * [Operator - Stateful fλ](docs.md#operator---stateful-fλ)
    * [Operator - Composition](docs.md#operator---composition)
    * [Matcher - Compatible methods](docs.md#matcher---compatible-methods)
  * [`evt.waitFor(...)`](docs.md#evtwaitfor-1)
    * [Without timeout](docs.md#without-timeout)
    * [With timeout](docs.md#with-timeout)
  * [`VoidEvt`](docs.md#voidevt-1)
  * [`evt.attachPrepend(...)` and  `evt.attachOncePrepend(...)`](docs.md#evtattachprepend-and-evtattachonceprepend)
  * [`evt.attachExtract(...)` and `evt.attachOnceExtract(...)`](docs.md#evtattachextract-and-evtattachonceextract)
  * [`evt.detach(...)`](docs.md#evtdetach)
    * [`evt.detach()` all handlers.](docs.md#evtdetach-all-handlers)
    * [`evt.handler(boundTo)` - bound to a given context](docs.md#evthandlerboundto---bound-to-a-given-context)
    * [`handler.detach(callback)`](docs.md#handlerdetachcallback)
  * [`evt.getHandlers()`](docs.md#evtgethandlers-1)
  * [Combining Once, Prepend, matcher, timeout and boundTo](docs.md#combining-once-prepend-matcher-timeout-and-boundto)
  * [`evt.createDelegate(...)`](docs.md#evtcreatedelegate)
  * [`evt.postCount`](docs.md#evtpostcount)
  * [`evt.evtAttach` and `evt.evtDetach`](docs.md#evtevtattach-and-evtevtdetach)
  * [`evt.isHandled(data)`](docs.md#evtishandleddata-1)
  * [`evt.postAsyncOnceHandled(data)` and `evt.postSyncOnceHandled(data)`](docs.md#evtpostasynconcehandleddata-and-evtpostsynconcehandleddata)
  * [`evtUtil.race([...])`](docs.md#evtutilrace)
  * [`NonPostable<Evt<T>>`](docs.md#nonpostableevtt)
  * [`UnpackEvt<typeof evt>`.](docs.md#unpackevttypeof-evt)
  * [`evt.enableTrace(...)`](docs.md#evtenabletrace)
* [`Observable<T>` documentation](docs.md#observablet-documentation)
* [Appendix: `evt.waitFor(...)` used in `async` procedure or loop](docs.md#appendix-evtwaitfor-used-in-async-procedure-or-loop)
* [History of the project](docs.md#history-of-the-project)
...
* `{ DETACH: Ctx }` When the event should be ignored and a group of handler bound to a certain context must be detached. See [`Ctx`](docs.md#Ctx)
