...
It is important to be sure that your filters always returns a `boolean`, typewise you will be warned it it is not the case but you must make be sure that it is actually the case at runtime.  
