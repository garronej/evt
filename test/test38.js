...
}
{
    ...
    var prRadius = (0, getHandlerPr_1.getHandlerPr)(evtShape_1, function () { return evtShape_1[methodName_1](matchCircle, function (circle) { return dRadius_2.resolve(circle.radius); }); }).then(function (_a) {
        var radius = _a.radius;
        return radius;
    });
    var dBigCircle_2 = new Deferred();
    var prBigCircle = (0, getHandlerPr_1.getHandlerPr)(evtShape_1, function () { return evtShape_1[methodName_1](function (shape) { return shape.type === "CIRCLE" && shape.radius > 100; }, function (bigCircle) {
