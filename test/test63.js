...
var console = { "log": function (str) { return console.stdOut += "" + str; }, "stdOut": "" };
...
assert_1.assert(console.stdOut
    ===
        [
            "1: 3",
            "3: FOO",
...
assert_1.assert(console.stdOut === "0");
console.stdOut = "";
