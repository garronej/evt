...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var timer, console, evtStr, ctx, _a, _b, str, e_1_1;
    var e_1, _c;
    var _d;
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 1:
                ...
                _a = __asyncValues(evtStr.getAsyncIterable(ctx, 150));
                _e.label = 2;
            ...
            case 13:
                ...
                if (((_d = ctx.completionStatus) === null || _d === void 0 ? void 0 : _d.type) === "ABORTED" && ctx.completionStatus.error instanceof lib_1.TimeoutEvtError) {
                    console.log("the loop was terminated because of timeout");
                }
                (0, assert_1.assert)(console.stdOut === "onetwoTIMEOUTthreeloop_endthe loop was terminated because of timeout");
                clearTimeout(timer);
...
//# sourceMappingURL=test106.js.map