...
if (1 + 0 === 2) {
    ...
    lib_1.Evt.from(document, "click")
        .pipe((0, lib_1.throttleTime)(1000), function (event) { return [parseInt(event.clientX.toFixed())]; }, [function (clientX, count) { return [count + clientX]; }, 0]).attach(function (count) { return console.log(count); });
    {
        var count_2 = 0;
        var rate_2 = 1000;
