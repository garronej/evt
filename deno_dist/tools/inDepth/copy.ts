...
import { assert } from "https://deno.land/x/tsafe@v1.0.1/assert.ts";
import { Polyfill as Map, LightMap } from "https://raw.githubusercontent.com/garronej/minimal_polyfills/v2.2.2/deno_dist/Map.ts";
type LightSet<T> = import("https://raw.githubusercontent.com/garronej/minimal_polyfills/v2.2.2/deno_dist/Set.ts").LightSet<T>;
