...
export type Operator<T, U, CtxResult = any> =
    import("../Operator.ts").Operator<T, U, CtxResult>;

namespace Operator {

    export type fλ<T, U, CtxResult = any> =
        import("../Operator.ts").Operator.fλ<T, U, CtxResult>;

    export namespace fλ {

        export type Stateless<T, U, CtxResult = any> =
            import("../Operator.ts").Operator.fλ.Stateless<T, U, CtxResult>;

    }

    export type Stateless<T, U, CtxResult = any> =
        import("../Operator.ts").Operator.Stateless<T, U, CtxResult>;
