import { id } from "https://raw.githubusercontent.com/garronej/tsafe/v0.10.0/deno_dist/id.ts";
...
import type { dom, Evt, EvtLike } from "./types/index.ts";
...
type CtxLike<Result> = import("./types/index.ts").CtxLike<Result> & {
