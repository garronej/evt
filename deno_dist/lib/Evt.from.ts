...
import * as _1 from "./types/EventTargetLike.ts";

namespace dom {

    export type HTMLElementEventMap = import("./types/lib.dom.ts").HTMLElementEventMap;
    export type WindowEventMap = import("./types/lib.dom.ts").WindowEventMap;
    export type DocumentEventMap = import("./types/lib.dom.ts").DocumentEventMap;
