...
declare type PromiseOrNot<T> = PromiseLike<T> | T;
/**
 ...
 */
export declare function asyncPipe<E extends EvtLike<any>, U>(evt: E, asyncOp: (data: UnpackEvt<E>) => PromiseOrNot<[U] | null>): import("./types/helper/SwapEvtType").UseVoidEvt<E extends StatefulReadonlyEvt<any> ? StatefulEvt<U | undefined> : E extends NonPostableEvt<any> ? Evt<U> : EvtLike<U>>;
export {};
