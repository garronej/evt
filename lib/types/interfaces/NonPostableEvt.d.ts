export declare type Operator<T, U, CtxResult = any> = import("../Operator").Operator<T, U, CtxResult>;
declare namespace Operator {
    type fλ<T, U, CtxResult = any> = import("../Operator").Operator.fλ<T, U, CtxResult>;
    namespace fλ {
        type Stateless<T, U, CtxResult = any> = import("../Operator").Operator.fλ.Stateless<T, U, CtxResult>;
    }
    type Stateless<T, U, CtxResult = any> = import("../Operator").Operator.Stateless<T, U, CtxResult>;
}
