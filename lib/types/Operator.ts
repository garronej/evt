import { typeGuard } from "../../tools/typeSafety/index.ts";
type CtxLike<Result> = import("./interfaces/index.ts").CtxLike<Result>;
type VoidCtxLike = import("./interfaces/index.ts").VoidCtxLike;
