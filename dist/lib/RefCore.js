...
var RefCore = /** @class */ (function () {
    ...
    RefCore.prototype.detach = function () {
        var e_1, _a;
        var _b;
    ...
    RefCore.prototype.addHandler = function (handler) {
        this.handlers.add(handler);
    };
    RefCore.prototype.removeHandler = function (handler) {
        this.handlers["delete"](handler);
    };
    RefCore.match = function (boundTo) {
        assert_1.assert(typeGuard_1.typeGuard.dry(boundTo));
        return !!boundTo.isRefCore;
    };
    return RefCore;
}());
