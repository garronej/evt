...
export declare function toReduceArguments<ArrOf, ReduceTo, Params extends any[]>(arrOp: (arr: readonly ArrOf[], ...params: Params) => ReduceTo, //TODO: readonly ArrOf[]
...params: Params): ReduceArguments<ArrOf, ReduceTo>;
